...
// Using a for loop, this function iterates through and accesses each element of the array, and
// subjects it to a simple test that we have created. In this way, we have easily and 
...
function filteredArray(arr, elem) {
    ...
    for (let i = 0; i < arr.length; i++) {
        // Every element of the array must then be compared to the elem parameter passed through 
        // the filteredArray() function.
          if (arr[i].indexOf(elem) == -1) {
            // If a match is NOT found then newArr have that entire subarray added. The push() function 
            // is very useful here.
        newArr.push(arr[i]);
      }
    }
